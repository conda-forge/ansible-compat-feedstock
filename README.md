...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ansible-compat-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ansible-compat-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ansible-compat
# for installing globally
pixi global install ansible-compat
```
...
It is possible to list all of the versions of `ansible-compat` available on your platform:
...
```
pixi search ansible-compat --channel conda-forge
```
